...
public class PersonaListener implements ActionListener{
	...
	/**
	 * Metodo que retorna un booleano indicando si el dni introducido es válido
	 * @param dni: seleccionado para demostrar si es válido
	 * @return el dni es válido o no
	 */
