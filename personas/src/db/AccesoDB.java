...
public class AccesoDB {
	 ...
	 * 
	 * @return con es el resultado de la conexión con la base de datos
	 * 
	 * @throws ClassNotFoundException excepcion en caso de que hay algún problema
	 * con la conexión a la base de datos
	 * 
	 * @throws SQLException excepcion en caso de que hay algún problema
	 * con la conexión a la base de datos
	 */
