...
/**
 * Esta clase sirve para crear la ventana que se utilizará para modificar los datos de un objeto 
...
public class VModificar extends JFrame {
	...
	/**
	 *En este metodo se encuentran todos los metodos que utilizará la clase VModificar
	 */
	public VModificar() {
		init();
	}
